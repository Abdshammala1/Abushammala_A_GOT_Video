(() => {
    ...
    let var1 = document["querySelectorAll"]('.sigilContainer'),
    // this will go and get the buttons at the bottom and create a NODE LIST
        var2 = document["querySelector"]('.lightbox'),
        var3 = var2["querySelector"]('.close-lightbox'),
        var4 = document["querySelector"]('video');
    imageBanner = document["querySelector"]('#houseImages');
    var var5 = document["querySelector"]('#muteVideo');

// I didnt know how to make the text show on the screen :(
    const houseData = [
    ...
    function var7() {
        ...
        var2["classList"]["add"]('show-lightbox');
        var4["src"] = var8 + `/` + var9 + `-${this["className"]["split"](' ')[1]["capIt"]()}.${var4["currentSrc"]["split"]('.')[1]}`;
        var4["load"]();
        var4["play"]();
        _0x4a6cx8(this["dataset"]["offset"])
    }

    function _0x4a6cx8(_0x4a6cx9) {
        let var6 = _0x4a6cx9 * 600 + "px";
        imageBanner["style"]["right"] = var6
    }

    function _0x4a6cxb() {
        var2["classList"]["remove"]('show-lightbox');
        var4["currentTime"] = 0;
        var4["pause"]()
    }

    function _0x4a6cxc() {
        let _0x4a6cxd = this["firstElementChild"];
        if (var4["paused"] == true) {
            var4["play"]();
            _0x4a6cxd["dataset"]["icon"] = "pause-circle"
        } else {
            var4["pause"]();
            _0x4a6cxd["dataset"]["icon"] = 'play-circle'
        }
    }

    var1["forEach"]((_0x4a6cxe) => _0x4a6cxe["addEventListener"]('click', var7));
    var3["addEventListener"]('click', _0x4a6cxb);
    var4["addEventListener"]('ended', _0x4a6cxb);
    var5["addEventListener"]("click", muteVideo)
})()